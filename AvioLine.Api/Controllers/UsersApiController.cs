...
namespace AvioLine.Api.Controllers
{
    ...
    public class UsersApiController : ControllerBase
    {
        ...
        /// </summary>
        private readonly UserStore<User, Role, IdentityContext> userStore;

        private readonly ILogger<UsersApiController> Logger;

        public UsersApiController(IdentityContext context, ILogger<UsersApiController> logger)
        {
            userStore = new UserStore<User, Role, IdentityContext>(context);
            Logger = logger;
        }
        ...
        [HttpPost("Role/{role}")]
        public async Task AddToRoleAsync([FromBody] User user, string role, [FromServices] IdentityContext context)
        {
        ...
        [HttpPost("AddClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimDTO claimInfo, [FromServices] IdentityContext context)
        {
        ...
        public async Task ReplaceClaimsAsync([FromBody] ReplaceClaimDTO claimInfo, [FromServices] IdentityContext context)
        {
        ...
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimDTO claimInfo, [FromServices] IdentityContext context)
        {
        ...
        #region Login
        [HttpPost("AddLogin")]
        public async Task AddLoginAsync([FromBody] AddLoginDTO login, [FromServices] IdentityContext context)
        {
